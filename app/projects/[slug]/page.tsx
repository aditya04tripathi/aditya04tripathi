...
export default async function ProjectPage({
	...
	return (
		<div className="container mx-auto px-4 sm:px-6 max-w-4xl">
			...
			{/* Project Image */}
			{project.image && (
				<FadeIn className="mb-8 sm:mb-10 md:mb-12 rounded-none overflow-hidden border bg-muted">
					<Image
						src={project.image}
						alt={project.name}
						width={1200}
			...
			<FadeIn className="space-y-4 mb-8 sm:mb-10 md:mb-12">
				...
				<div className="bg-secondary/10 p-6 rounded-none border border-primary/10">
