                ...
                >
                    <div className="bg-background/80 backdrop-blur-md border border-border shadow-lg rounded-full px-4 py-2 flex items-center gap-4 pointer-events-auto max-w-2xl w-full justify-between">
                        <div className="flex items-center gap-3">
                            <motion.div layoutId="hero-avatar" className="relative h-10 w-10 overflow-hidden rounded-full">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link href="/contact">
                                <Button size="sm" className="rounded-full h-8 px-4 text-xs font-mono font-bold">
                                    Contact
                                </Button>
                            </Link>
                        </div>
