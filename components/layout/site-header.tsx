    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-6 py-6 pointer-events-none">
            <div className="w-full max-w-5xl flex items-center justify-between">
                ...
                >
                    <Link href="/projects">
                        <Button variant="ghost" size="sm" className="font-mono text-xs hover:bg-secondary/80 transition-all duration-300 hover:scale-105">
                            Projects
                        </Button>
                    </Link>
                    ...
                    <Link href={CREATOR_INFO.github} target="_blank">
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground transition-all duration-300 hover:scale-110">
                    ...
                    <Link href="/contact">
                        <Button size="sm" className="h-8 px-4 text-xs font-mono font-bold ml-1 transition-all duration-300 hover:scale-105 hover:shadow-md">
                            Contact
                        </Button>
                    </Link>
                </motion.div>
                    ...
                    >
                        <nav className="flex flex-col items-center gap-6 p-6">
                             <Link href="/projects" onClick={() => setIsMobileMenuOpen(false)}>
                                <span className="text-2xl font-mono font-bold hover:text-primary transition-colors">Projects</span>
                            </Link>
                            <Link href="/engineering" onClick={() => setIsMobileMenuOpen(false)}>
                                <span className="text-2xl font-mono font-bold hover:text-primary transition-colors">Engineering</span>
                            </Link>
                            <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)}>
                                <span className="text-2xl font-mono font-bold hover:text-primary transition-colors">Contact</span>
                            </Link>
