            ...
            <FadeIn>
    			<div className="flex flex-col items-center text-center space-y-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        <Button size="lg" className="h-12 px-8 text-base font-mono font-bold" asChild>
                            <Link href="/contact">
                                <MailIcon className="mr-2 size-5" />
                                Get_In_Touch
                            </Link>
                        </Button>
                        <Button variant="outline" size="lg" className="h-12 px-8 text-base font-mono" asChild>
