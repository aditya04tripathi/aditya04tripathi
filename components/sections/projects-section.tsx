      ...
      <div className="space-y-8">
        {projects.map((project) => (
          <FadeIn key={project.slug}>
            <Card className="border-border/60 bg-card/50 backdrop-blur-sm overflow-hidden group hover:border-primary/40 transition-all duration-300 rounded-none hover:-translate-y-1 hover:shadow-lg">
