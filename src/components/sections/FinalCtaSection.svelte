    ...
    <div class="flex flex-col items-center text-center space-y-8">
        <div class="space-y-4 max-w-3xl">
            ...
            >
                ...
                to collaborations. Whether you have a project in mind, need help
                with development, or just want to connect, feel free to reach
                out!
            </p>
        </div>
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <Button
                ...
                class="h-12 px-8 text-base font-mono font-bold"
            >
