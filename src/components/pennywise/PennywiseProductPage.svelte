    ...
    <div class="container mx-auto px-4 sm:px-6 max-w-4xl">
        <div class="pt-8 pb-12 border-b border-border/40">
            <div class="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                ...
                <div class="min-w-0 flex-1">
                    <p
                        class="font-mono text-xs text-muted-foreground uppercase tracking-widest mb-4"
                    >
                        Product
                    </p>
                    <h1 class="type-h1 mb-4">PennyWise</h1>
                    <p class="type-h3 text-muted-foreground mb-6">
                        Private Offline Expense Tracker
                    </p>
                    <p
                        class="type-body max-w-2xl leading-relaxed text-foreground/90"
                    >
                        Track your finances with full privacy. No cloud. No
                        account. No data leaving your device.
                    </p>
                ...
                {#each features as f (f.title)}
                    <Card class="rounded-none border-border/60 bg-card/50">
                        <CardHeader class="pb-2">
                            <CardTitle class="type-h6 font-mono"
                                >{f.title}</CardTitle
                            >
                        </CardHeader>
                        <CardContent>
        ...
        <section class="py-12 space-y-4">
            ...
            <Card class="rounded-none border-border/60 bg-secondary/5">
                <CardContent
                    class="pt-6 pb-6 space-y-4 text-sm text-muted-foreground leading-relaxed"
                >
                    <p>PennyWise is built with a local-first architecture.</p>
                    <p>
                        Your financial data stays on your device and is not
                        stored on PennyWise servers.
                    </p>
                    <p>
                        The app may display ads using Google AdMob, which may
                        collect limited device-level data.
                    </p>
                    <p>
                        <a
                            href={PENNYWISE_PRIVACY_PATH}
