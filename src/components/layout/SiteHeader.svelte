    ...
    >
        ...
        >
            ...
            <div class="flex flex-col pr-2">
                <span
                    class="font-mono font-bold text-sm leading-none tracking-tight"
                    >{CREATOR_INFO.name}</span
                >
                <span
    ...
    {#if isMobileMenuOpen}
        ...
        >
            <nav
                ...
                transition:fly={menuFly}
            >
                <a href="/pennywise" onclick={() => (isMobileMenuOpen = false)}>
                    <span
                        class="text-2xl font-mono font-bold hover:text-primary transition-colors"
                        >PennyWise</span
                    >
                </a>
                ...
                <div class="flex items-center gap-6">
                    ...
                    >
                        <span aria-hidden="true">
                            <IconGithub
                                class="size-6 text-muted-foreground hover:text-foreground transition-colors"
                            />
                        </span>
                    </a>
                    <a
